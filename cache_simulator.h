...
typedef struct cache {
    int    ** Cache_Data;  /** The blocks are Cache_Data[set][line], with all words
                             ...
                             */
	int    ** Trait; 		/** 1 = privileged, 0 = unprivileged*/	
    ...
    long unsigned ** T_Access;      /** Time stamp (Used a counter) for the access
                                      ...
                                      */
    long unsigned ** Hit_Frequency; /** counter for the data hit
                                      *     load in the cache memory(used in the LFU Algorithm).
                                      */
} Cache;
/******************************************************************************/
...
int there_Are_Space_Set(Cache *cache1, int index1, int associativity, int special);
int random_free_space_set (Cache *cache1, int index1, int associativity, int special);
int findLessAccessTSset (Cache *cache1, int index1, int associativity, int special);
int findLessHitFrequencyset (Cache *cache1, int index1, int associativity, int special);
